...
class HUD: SKNode {
    ...
    func configureUI(screenSize: CGSize) {
        ...
        scoreBackground.anchorPoint = CGPoint(x: 1.0, y: 0.5) // точка, относительно которой на объекте выполняются вычисления
        ...
        menuButton.anchorPoint = CGPoint(x: 0.0, y: 0.0)  // смещаем в левый нижний угол изображения
