...
//MARK: - START
    ...
    private func loadTasks() {
        ...
        // будем использоватьтолько те задачи, для которых определена секция в таблице
    ...
    //порядок отображение задач по их статусу
    ...
    override func tableView(_ tableView: UITableView, leadingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        //получаем данные о задаче, по которой необходимо осущесвить свайп
        let taskType = sectionsTypesPosition[indexPath.section]
        guard let _ = tasks[taskType]?[indexPath.row] else {
            return nil
        }
        ...
        //создаем объект, описывающий доступные действия в зависимости от статуса задачи будет отображено 1 или 2 действия
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        ...
        let taskType = sectionsTypesPosition[indexPath.section]
        //удаляем задачу, т.к. она соответствует строкам
